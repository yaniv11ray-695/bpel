...
/**
 * Content provider for PropertyAliases (NOT Properties!).
 * 
 * Expects a Definition or Process as input.
 */
public class PropertyAliasContentProvider extends AbstractContentProvider {
	...
	public void collectElements(Object input, List list )  {
		...
		if (input instanceof Definition) {
			...
			// of what properties and propertyAliases are available and where?
